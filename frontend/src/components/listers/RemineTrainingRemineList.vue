                ...
                <v-list-item v-for="(data, n) in values" :key="n">
                    ...
                    <v-list-item-content>
                        ...
                        <v-list-item-subtitle style="font-size:25px; font-weight:700;">
                            ...
                            [ RemainingTrainingCount :  {{data.remainingTrainingCount }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            [ Status :  {{data.status }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    ...
                    <RemineTrainingRemine :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" @add="append" v-if="tick"/>
...
<script>
    ...
    export default {
        ...
        async created() {
            ...
            this.values = temp.data._embedded.trainingremines;
