...
pluralCaseList.push( {plural: "climbings/climbingMemberships", pascal: "ClimbingClimbingMembership"} )
pluralCaseList.push( {plural: "climbings/climbingTrainingCourseTickets", pascal: "ClimbingClimbingTrainingCourseTicket"} )

pluralCaseList.push( {plural: "remines/membershipRemines", pascal: "RemineMembershipRemine"} )
pluralCaseList.push( {plural: "remines/trainingRemines", pascal: "RemineTrainingRemine"} )

pluralCaseList.push( {plural: "trainingCourses/climbingTrainingCourseInfos", pascal: "TrainingCourseClimbingTrainingCourseInfo"} )

pluralCaseList.push( {plural: "notifications/climbingNotifications", pascal: "NotificationClimbingNotification"} )
