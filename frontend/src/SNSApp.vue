        ...
        <div>
            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    <v-list-item
                        class="px-2"
                        key="climbingMemberships"
                        to="/climbings/climbingMemberships"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="climbingTrainingCourseTickets"
                        to="/climbings/climbingTrainingCourseTickets"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="membershipRemines"
                        to="/remines/membershipRemines"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="climbingTrainingCourseInfos"
                        to="/trainingCourses/climbingTrainingCourseInfos"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                        ClimbingTrainingCourseInfo
                    </v-list-item>


                    <v-list-item
                        class="px-2"
                        key="climbingNotifications"
                        to="/notifications/climbingNotifications"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: 'ClimbingMembership', 
                description: '', 
                key: 'climbingMemberships', 
                route: '/climbings/climbingMemberships',
                ImageUrl: '',
            },
            { 
                title: 'ClimbingTrainingCourseTicket', 
                description: '', 
                key: 'climbingTrainingCourseTickets', 
                route: '/climbings/climbingTrainingCourseTickets',
                ImageUrl: '',
            },
            { 
                title: 'MembershipRemine', 
                description: '', 
                key: 'membershipRemines', 
                route: '/remines/membershipRemines',
                ImageUrl: '',
            },
            { 
                title: 'TrainingRemine', 
                description: '', 
                key: 'trainingRemines', 
                route: '/remines/trainingRemines',
                ImageUrl: '',
            },
            { 
                title: 'ClimbingTrainingCourseInfo', 
                description: '', 
                key: 'climbingTrainingCourseInfos', 
                route: '/trainingCourses/climbingTrainingCourseInfos',
                ImageUrl: '',
            },
            { 
                title: 'ClimbingNotification', 
                description: '', 
                key: 'climbingNotifications', 
                route: '/notifications/climbingNotifications',
                ImageUrl: '',
            },
